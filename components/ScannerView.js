    ...
    return (
        <div className="space-y-6 slide-up h-full flex flex-col justify-center items-center py-4 sm:py-10">
            <div className="w-full max-w-md bg-white dark:bg-gray-800 rounded-3xl shadow-xl border border-gray-100 dark:border-gray-700 p-6 flex flex-col items-center text-center relative overflow-hidden">
                ...
                {/* Wadah Kamera: Disesuaikan agar seluruh video masuk pas dan tidak terpotong */}
                <div className="w-full max-w-sm rounded-3xl overflow-hidden shadow-inner border-4 border-gray-100 dark:border-gray-700 relative bg-black mb-6 min-h-[260px] flex items-center justify-center [&_video]:w-full [&_video]:h-auto [&_video]:max-h-[380px] [&_video]:object-contain">
                    {!isInputModalOpen ? (
                        <Html5QrcodePlugin qrCodeSuccessCallback={handleScan} />
                    ) : (
                        <div className="w-full min-h-[260px] py-10 flex flex-col items-center justify-center text-wiz-green bg-gray-900">
